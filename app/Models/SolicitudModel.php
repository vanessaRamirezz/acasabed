...
class SolicitudModel extends Model
{
    ...
    public function getInfoSolicitudPorId($idSolicitud = null, $idContrato = null)
    {
        // =========================================================
        // VALIDAR
        // =========================================================
        if (empty($idSolicitud) && empty($idContrato)) {
            return null;
        }
        ...
        if (!empty($idSolicitud)) {
            ...
            $builder->where('solicitudes.id_solicitud', $idSolicitud);
        }
        ...
        // =========================================================
            ...
            $builder->join(
                'solicitudes',
                'solicitudes.id_solicitud = contratos.id_solicitud',
                'left'
            );

            $builder->where('contratos.id_contrato', $idContrato);
        }
    ...
    ", false);
        ...
        $builder->join(
            'clientes',
            'clientes.id_cliente = COALESCE(solicitudes.id_cliente, contratos.id_cliente)',
            'left'
        );
        ...
        $builder->join(
            'beneficiarios',
            'beneficiarios.id_beneficiario = solicitudes.id_beneficiario',
            'left'
        );
        ...
        $builder->join(
            'plan_de_pago',
            'plan_de_pago.id_plan_de_pago = solicitudes.id_plan_de_pago',
            'left'
        );
        ...
        $builder->join(
            'firmantes AS f1',
            'f1.id_firmante = solicitudes.id_firmante_1',
            'left'
        );

        $builder->join(
            'firmantes AS f2',
            'f2.id_firmante = solicitudes.id_firmante_2',
            'left'
        );
        ...
        $builder->join(
            'departamentos',
            'departamentos.id_departamento = clientes.id_departamento',
            'left'
        );

        $builder->join(
            'municipios',
            'municipios.id_municipio = clientes.id_municipio',
            'left'
        );

        $builder->join(
            'distritos',
            'distritos.id_distrito = clientes.id_distrito',
            'left'
        );

        $builder->join(
            'colonias',
            'colonias.id_colonia = clientes.id_colonia',
            'left'
        );
        ...
        $builder->join(
            'rutas',
            'rutas.id_ruta = contratos.id_ruta',
            'left'
        );
        ...
        $builder->join(
            'medidores',
            'medidores.id_medidor = contratos.id_medidor',
            'left'
        );
        ...
        $builder->join(
            'tarifas',
            'tarifas.id_tarifa = contratos.id_tarifa',
            'left'
        );
        ...
        $builder->join(
            'tipos_de_cliente',
            'tipos_de_cliente.id_tipo_cliente = tarifas.id_tipo_cliente',
            'left'
        );
