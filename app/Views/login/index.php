...
<head>
    ...
    <title>ACASABED | Iniciar</title>
    <link rel="icon" type="image/png" href="<?= base_url('dist/img/agua.png') ?>">
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Credenciales de Acceso</p>
    ...
    <script type="module" src="<?= base_url('dist/js/login/login.js') ?>"></script>
