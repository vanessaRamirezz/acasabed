...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Reporte de Pagos</h1>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-12">
                ...
                <div id="pdfBox" style="position:relative; width:100%; height:600px; border:1px solid #ddd; background:#f8f9fa;">
                    ...
                    ">
                        ...
                        <p style="margin-top:8px;">Selecciona un periodo y presiona <b>Generar Reporte</b></p>
                    </div>
...
<script type="module" src="<?= base_url('dist/js/reporte_pagos/rp_pagos.js') ?>"></script>
<?= $this->endSection() ?>