...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <h5 class="m-0">Solicitudes Creadas</h5>
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <h5 class="m-0">Solicitudes Aprobadas</h5>

                <div class="d-flex justify-content-end mb-4">
                    <div class="input-group col-md-6">
                        <input type="text" id="customSearchSolicitudesAprobadas" placeholder="Buscar por numero solicitud ó nombre de cliente" class="form-control">
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" id="searchBtnSolicitudesAprobadas" type="button">
                                <i class="fas fa-search"></i>
                            </button>
                            <button class="btn btn-outline-secondary" id="clearSearchBtnSolicitudesAprobadas" type="button">
                                <i class="fas fa-times"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm" id="tbl-solicitudes-aprobadas">
                        <thead>
                            <tr>
                                <th>Numero Solicitud</th>
                                <th>Nombre / Razón social</th>
